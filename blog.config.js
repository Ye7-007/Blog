...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '94d1cffe3a5082dba9d981eece03b2fe',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yeam', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个养生的技术宅', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yeam.cc.cd', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://jlr.scene7.com/is/image/jlr/X15224GL_303101393_009?wid=2000&fit=stretch%2C1', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    '技术宅一位, Hi，我是DIY-maker,Hi，欢迎来到我的博客🎉',
