const CONFIG = {
  ...
  COMMERCE_TEXT_CENTER_TITLE: 'Record', // 中间产品区块标题
  COMMERCE_TEXT_CENTER_DESCRIPTION:
    'welcome to my create world.', // 中间产品区块文字描述
  COMMERCE_TEXT_CENTER_CATEGORY_TITLE: 'Record Categories', // 左侧产品分类标题
  COMMERCE_TEXT_FOOTER_TITLE: 'Contact US', // COMMERCE主题页脚文案标题；按Shift+Enter键可以换行
  COMMERCE_TEXT_FOOTER_MENU_1: 'Record', // COMMERCE主题页脚左侧菜单标题1
